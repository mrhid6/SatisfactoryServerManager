...
router.post("/generatedebugreport", middleWare, (req, res) => {
    ...
    ServerApp.API_GenerateDebugReport(post)
        .then(() => {
            res.json({
                result: "success",
            });
...
router.post("/debugreport/download", middleWare, (req, res) => {
    ...
    ServerApp.API_DownloadDebugReportFile(req.body, UserID)
        .then((saveFile) => {
...
router.post("/debugreport/remove", middleWare, (req, res) => {
    ServerApp.API_RemoveDebugReportFile(req.body)
        .then(() => {
            res.json({
                result: "success",
            });
...
router.post("/addwebhook", middleWare, (req, res) => {
    ServerApp.API_AddWebhook(req.body)
        .then(() => {
            res.json({
                result: "success",
            });
